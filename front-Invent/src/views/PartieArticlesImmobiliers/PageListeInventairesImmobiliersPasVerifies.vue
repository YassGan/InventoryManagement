...
export default {
  ...
  mounted() {
    ...
    document.title = "Inventaires Immobiliers pas encore validés";
  },

  methods: {
    InventoryDetailPage(id) {
      router.push("/PageValidationInventaireImmobilier/" + id);
    },
    ...
    async fetchInventories() {
      ...
      try {
        ...
        const response = await HTTP.get(
          `InventairesImmobiliersAPI/getAllInventaires_Immobiliers_non_verifie/${User_loggedin_info_Object.idSociete}`,
          {}
        );
